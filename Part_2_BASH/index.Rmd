...
echo "12121" >> numbers.txt
echo "3434" >> numbers.txt
echo "123" >> numbers.txt
echo "12341239879" >> numbers.txt
```
...
```{bash}
chmod u=rw, o=r, g=r numbers.txt 
```
...
Fist, we install wget with $ brew install wget
```{bash}
...
*/8**** echo "Reminder" | mailx -s "reminder" melas@med.usc.edu
